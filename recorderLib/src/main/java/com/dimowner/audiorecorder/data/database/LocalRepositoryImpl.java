...
// */
	...
	public List<Record> getRecords(int page, int order) {
		...
		String orderStr;
		switch (order) {
			case CommonConstants.SORT_NAME:
				orderStr = SQLiteHelper.COLUMN_NAME + " ASC";
				break;
			case CommonConstants.SORT_NAME_DESC:
				orderStr = SQLiteHelper.COLUMN_NAME + " DESC";
				break;
			case CommonConstants.SORT_DURATION:
				orderStr = SQLiteHelper.COLUMN_DURATION + " DESC";
				break;
			case CommonConstants.SORT_DURATION_DESC:
				orderStr = SQLiteHelper.COLUMN_DURATION + " ASC";
				break;
			case CommonConstants.SORT_DATE_DESC:
				orderStr = SQLiteHelper.COLUMN_DATE_ADDED + " ASC";
				break;
			case CommonConstants.SORT_DATE:
			default:
...
//				}
	...
	public void removeOutdatedTrashRecords() {
		...
		for (int i = 0; i < list.size(); i++) {
			if (list.get(i).getRemoved() + CommonConstants.RECORD_IN_TRASH_MAX_DURATION < curTime) {
