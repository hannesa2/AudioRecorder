...
//		setStoreDirPublic(true);
	...
	public int getRecordChannelCount() {
		return sharedPreferences.getInt(PREF_KEY_RECORD_CHANNEL_COUNT, CommonConstants.RECORD_AUDIO_STEREO);
	}
	...
	public int getFormat() {
		return sharedPreferences.getInt(PREF_KEY_FORMAT, CommonConstants.RECORDING_FORMAT_M4A);
	}

	private int getBitrate() {
		return sharedPreferences.getInt(PREF_KEY_BITRATE, CommonConstants.RECORD_ENCODING_BITRATE_128000);
	}

	private int getSampleRate() {
		return sharedPreferences.getInt(PREF_KEY_SAMPLE_RATE, CommonConstants.RECORD_SAMPLE_RATE_44100);
	}
	...
	public int getRecordsOrder() {
		return sharedPreferences.getInt(PREF_KEY_RECORDS_ORDER, CommonConstants.SORT_DATE);
	}

	public int getNamingFormat() {
		return sharedPreferences.getInt(PREF_KEY_NAMING_FORMAT, CommonConstants.NAMING_COUNTED);
	}
	...
	public void migrateSettings() {
		...
		if (bitrate == CommonConstants.RECORD_ENCODING_BITRATE_24000) {
			bitrate = CommonConstants.RECORD_ENCODING_BITRATE_48000;
		}
		...
		switch (color) {
			case 1:
				colorKey = CommonConstants.THEME_BLACK;
				break;
			case 2:
				colorKey = CommonConstants.THEME_TEAL;
				break;
			case 3:
				colorKey = CommonConstants.THEME_BLUE;
				break;
			case 4:
				colorKey = CommonConstants.THEME_PURPLE;
				break;
			case 5:
				colorKey = CommonConstants.THEME_PINK;
				break;
			case 6:
				colorKey = CommonConstants.THEME_ORANGE;
				break;
			case 7:
				colorKey = CommonConstants.THEME_RED;
				break;
			case 8:
				colorKey = CommonConstants.THEME_BROWN;
				break;
			case 0:
			case 9:
				colorKey = CommonConstants.THEME_BLUE_GREY;
				break;
			default:
				colorKey = CommonConstants.DEFAULT_THEME_COLOR;
		}

		String recordingFormatKey;
		switch (recordingFormat) {
			case CommonConstants.RECORDING_FORMAT_WAV:
				recordingFormatKey = CommonConstants.FORMAT_WAV;
				break;
			case CommonConstants.RECORDING_FORMAT_M4A:
				recordingFormatKey = CommonConstants.FORMAT_M4A;
				break;
			default:
				recordingFormatKey = CommonConstants.DEFAULT_RECORDING_FORMAT;
		}
		String namingFormatKey;
		switch (nameFormat) {
			case CommonConstants.NAMING_DATE:
				namingFormatKey = CommonConstants.NAME_FORMAT_DATE;
				break;
			case CommonConstants.NAMING_COUNTED:
				namingFormatKey = CommonConstants.NAME_FORMAT_RECORD;
				break;
			default:
				namingFormatKey = CommonConstants.DEFAULT_NAME_FORMAT;
		}
	...
	public String getSettingThemeColor() {
		return sharedPreferences.getString(PREF_KEY_SETTING_THEME_COLOR, CommonConstants.DEFAULT_THEME_COLOR);
	}
	...
	public String getSettingNamingFormat() {
		return sharedPreferences.getString(PREF_KEY_SETTING_NAMING_FORMAT, CommonConstants.DEFAULT_NAME_FORMAT);
	}
	...
	public String getSettingRecordingFormat() {
		return sharedPreferences.getString(PREF_KEY_SETTING_RECORDING_FORMAT, CommonConstants.DEFAULT_RECORDING_FORMAT);
	}
	...
	public int getSettingSampleRate() {
		return sharedPreferences.getInt(PREF_KEY_SETTING_SAMPLE_RATE, CommonConstants.DEFAULT_RECORD_SAMPLE_RATE);
	}
	...
	public int getSettingBitrate() {
		return sharedPreferences.getInt(PREF_KEY_SETTING_BITRATE, CommonConstants.DEFAULT_RECORD_ENCODING_BITRATE);
	}
	...
	public int getSettingChannelCount() {
		return sharedPreferences.getInt(PREF_KEY_SETTING_CHANNEL_COUNT, CommonConstants.DEFAULT_CHANNEL_COUNT);
	}

	@Override
	public void resetSettings() {
		SharedPreferences.Editor editor = sharedPreferences.edit();
//		editor.putString(PREF_KEY_SETTING_THEME_COLOR, CommonConstants.DEFAULT_THEME_COLOR);
//		editor.putString(PREF_KEY_SETTING_NAMING_FORMAT, CommonConstants.DEFAULT_NAME_FORMAT);
		editor.putString(PREF_KEY_SETTING_RECORDING_FORMAT, CommonConstants.DEFAULT_RECORDING_FORMAT);
		editor.putInt(PREF_KEY_SETTING_SAMPLE_RATE, CommonConstants.DEFAULT_RECORD_SAMPLE_RATE);
		editor.putInt(PREF_KEY_SETTING_BITRATE, CommonConstants.DEFAULT_RECORD_ENCODING_BITRATE);
		editor.putInt(PREF_KEY_SETTING_CHANNEL_COUNT, CommonConstants.DEFAULT_CHANNEL_COUNT);
		editor.apply();
	}
}
