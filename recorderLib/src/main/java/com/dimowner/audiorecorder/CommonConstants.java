...
public class CommonConstants {
	 ...
	 *  Used for short records (shorter than {@link CommonConstants#LONG_RECORD_THRESHOLD_SECONDS}) */
	public static final int SHORT_RECORD_DP_PER_SECOND = 25;

	/** Waveform length, measured in screens count of device.
	 *  Used for long records (longer than {@link CommonConstants#LONG_RECORD_THRESHOLD_SECONDS})   */
	 ...
	 *  Used for long records visualisation algorithm. (longer than {@link CommonConstants#LONG_RECORD_THRESHOLD_SECONDS} ) */
